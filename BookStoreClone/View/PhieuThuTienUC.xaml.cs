...
namespace BookStoreClone.View
{
    ...
    public partial class PhieuThuTienUC : UserControl
    {
		...
		private void btnThanhToan_Click(object sender, System.Windows.RoutedEventArgs e)
		{
			MessageBoxResult result = MessageBox.Show("In phiếu thu?", "Thông báo", MessageBoxButton.YesNo, MessageBoxImage.Information);
			if (result == MessageBoxResult.Yes)
					try
					{
						...
						{
							printDialog.PrintVisual(pnlthutien, "Phiếu Thu");
						}
					}
					finally
					{
